...
const filterOrders = async (req, res) => {
    const { order_id, customer_id, items_per_page, page } = req.query;
    const client_id = CommonFunction.getCustomerId(req, res);
    ...
    try {
        let orderDetails = await restaurantService.searchOrders(client_id, customer_id, order_id);
...
const filterOrdersByCustomer = async (req, res) => {
    const { order_id, client_id, items_per_page, page } = req.query;
...
export { searchMenuItems, getCategoryItems, getOffersBanner, getPopularItems, login, OrdersStatusUpdate, filterOrders, getProfileDetails, filterOrdersByCustomer, CreateOrderInFirebase };