...
export const verifyOtp = async (req, res) => {
    ...
    try {
        ...
        const testEmails = ["devendra.singh+2@rivette.com", "kuldeep.dev@rivette.com", "archana.manchanda@rivette.com", "deepika.malhotra@rivette.com"];
        ...
        if (twRes.success || twRes.data.success) {
            ...
            return res.status(200).json(CommonFunction.succsMessage("success", { token }));
        } else {
